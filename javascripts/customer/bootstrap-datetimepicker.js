...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		place: function () {
			...
			var offset, top, left, containerOffset, containerHeight;
			...
			// This is dumb and breaks everything.  Don't use it, or you'll have a bad time.
		...
		update: function () {
			...
			//if we got an invalid date, reset it to the initial
			if (this.date == null || this.date == "Invalid Date") {
	...
	var DPGlobal = {
		...
		parseDate:        function (date, format, language, type) {
			...
			if (parts.length == format.parts.length) {
				...
				//if there are no pieces to this date, then just return null (the library can handle resetting it to whatever it wants)
				date = null;
			}
